...
require('../../bower_components/ajaxform/build/ajaxform-0.1.2.js');
...
require('../../template_content/assets/plugins/data-tables/DT_bootstrap.css');
require('../../template_content/assets/css/style-metronic.css');

require('../../template_content/assets/plugins/select2/select2.min.js');
require('../../template_content/assets/plugins/data-tables/jquery.dataTables.min.js');
require('../admin/datetabesmy.js');
